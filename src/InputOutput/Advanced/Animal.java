...
/*
Дан сериализуемый класс Animal. Реализуйте метод, который из переданного массива байт восстановит массив объектов Animal.
...
class Animal implements Serializable {
    ...
    public static Animal[] deserializeAnimalArray(byte[] data) {
        ...
        try {
            ...
            countOfAnimals = inputStream.readInt();
            animals = new Animal[countOfAnimals];
            for (int i = 0; i < countOfAnimals; i++) {
                Animal a = (Animal) inputStream.readObject();
                animals[i] = a;
            }
        } catch (Exception e) {
